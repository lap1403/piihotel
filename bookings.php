...
<head>
  ...
  <title><?php echo $settings_r['site_title'] ?> - PHÒNG ĐƯỢC ĐẶT</title>
</head>
    ...
    <div class="row">
      ...
      while ($data = mysqli_fetch_assoc($result)) {
        ...
        if ($data['booking_status'] == 'Đã Thanh Toán') {
          ...
          <form class='momo' method='POST' target='_blank' enctype='application/x-www-form-urlencoded' action='momo.php'>
          <input type='submit' name='momo' value='MOMO QRCODE' class='btn custom-bg w-20 mt-2'>
          </form>
          <form class='momoatm' method='POST' target='_blank' enctype='application/x-www-form-urlencoded' action='momo_atm.php'>
          <input type='submit' name='momoatm' value='MOMO ATM' class='btn custom-bg w-20 mt-2'>
          </form>
          ";
        }
