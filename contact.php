...
<body class="bg-light">
                ...
                <div class="bg-white rounded shadow p-4 ">
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="message" required type="text" class="form-control shadow-none" row="5" style="resize:none;"></textarea>
                        </div>
    ...
    <?php
        if(isset($_POST['send'])){
            ...
            $q="INSERT INTO `user_que`(`name`, `email`, `subject`, `message`) VALUES (?,?,?,?)";
