                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="name"  class="form-control shadow-none" require>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <input type="number" min="1" name="price"  class="form-control shadow-none" require>
                        </div>
                        <div class="col-md-6 mb-3">
                        <label class="form-label">Quantity</label>
                        <input type="number" min="1" name="quantity"  class="form-control shadow-none" require>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <input type="number" min="1" name="children"  class="form-control shadow-none" require>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="desc" rows="4" class="form-control shadow-none" require></textarea>
                        </div>
                      </d>
                    </div>
