   ...
   <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <!-- shutdown section -->
                <div class="card  boder-0 shadow-sm" >
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="container-fluid p-0">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Phone Numbers(+Country Code)</label>
                                        ...
                                        <div class="input-group mb-3">
                                        <span class="input-group-text"><i class="bi bi-telephone-fill"></i></span>
                                        <input type="number" name="pn2" id="pn2_inp" class="form-control shadow-none" require>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Email</label>
                                        <input type="text" name="email" id="email_inp" class="form-control shadow-none" require>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="member_name" id="member_name_inp" class="form-control shadow-none" require>
                        </div>
                        <div class="mb-3">
                        <label class="form-label">Picture</label>
                        <input type="file" name="member_picture" id="member_picture_inp" accept="[.jpg, .png, .webp, .jpeg]" class="form-control shadow-none" require>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        function upd_shutdown(val)
            {
                ...
                xhr.onload=function(){
                    ...
                    {
                    alert('success','site have benn shutdown!');
                        get_general();
                    }
                    else{
                        alert('success',' mode off!');
                    }
                }
